...
namespace SRPV1
{
    class Program
    {
        ...
        /// <summary> // Exception: You must set the Id to the Book Id you want to load.
        /// Exception: You must set the Id to the Book Id you want to load.
        /// </summary>
        ...
        /// <summary> Exception: The following Id does not contain any book 
        /// 
        /// </summary>
        ...
        /// <summary>
        /// It uses the Book.NextId static property, which
        /// increments the Id. That breaks encapsulation and leaks the creation logic out to the consumer, which is another problem 
